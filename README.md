...
This repository uses `electricworry`'s [`apt-mirror`](https://github.com/electricworry/apt-mirror),
commit `4aa6775`.
...
> This repository is shipped with the Ubuntu 24.04 default `mirror.list` (expect ~235Gb to be downloaded)
